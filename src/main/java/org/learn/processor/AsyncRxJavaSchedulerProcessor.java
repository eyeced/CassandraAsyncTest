 ...
 */
@Component
public class AsyncRxJavaSchedulerProcessor extends AbstractProcessor {

    private static final Logger LOGGER = LoggerFactory.getLogger(AsyncRxJavaSchedulerProcessor.class);
    /**
     * start the process
     *
     * @param readings
